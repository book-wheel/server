...
public interface MemberRepository extends JpaRepository<Member, String> {
    ...
    boolean existsByGroup_GroupIdAndUser_Id(String groupId, String userId);

    // 특정 그룹 안에서 이 사용자가 '어떤 멤버'로 등록되어 있는지 단 한 명의 정보 조회
    // 로그인한 '나(User)'의 정보를 기준으로 해당 그룹에서의 멤버 프로필을 찾는 용도
    Optional<Member> findByGroup_GroupIdAndUser_Id(String groupId, String userId);
    ...
    long countByGroup_GroupIdAndUser_IdIn(String groupId, List<String> userIds);
}
